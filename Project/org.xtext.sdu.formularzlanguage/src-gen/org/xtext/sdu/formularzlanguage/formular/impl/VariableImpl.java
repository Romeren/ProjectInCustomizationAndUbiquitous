...
public class VariableImpl extends PrimitiveImpl implements Variable
{
  ...
  {
    return FormularPackage.Literals.VARIABLE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FormularPackage.VARIABLE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case FormularPackage.VARIABLE__NAME:
        return getName();
    }
