...
public interface Tile extends EObject
{
   ...
   * @see #setName(String)
   * @see org.xtext.sdu.iotvizualizerlanguage.vizualizer.VizualizerPackage#getTile_Name()
   * @model
   * @generated
   */
  String getName();
  ...
  /**
   * Sets the value of the '{@link org.xtext.sdu.iotvizualizerlanguage.vizualizer.Tile#getName <em>Name</em>}' attribute.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
