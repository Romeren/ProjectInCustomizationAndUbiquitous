...
public class VizualizerGenerator extends AbstractGenerator {
  ...
  protected CharSequence _compile(final Graph graph, final CharSequence colorClass) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("var headers= [\"time\", \"value\"];");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("for(var i=1;i<value.length;i++){");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("var obj = {};");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("var currentline=value[i];");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("var max = null;");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("var min = null;");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("result.forEach(function(d) {");
    _builder.newLine();
    _builder.append("\t\t\t  ");
    _builder.append("d.date = \tnew Date(d.time);");
    _builder.newLine();
    _builder.append("\t\t\t  ");
    _builder.append("if(max == null || max < d.value){max = d.value}");
    _builder.newLine();
    _builder.append("\t\t\t  ");
    _builder.append("if(min == null || min > d.value){min = d.value}");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
