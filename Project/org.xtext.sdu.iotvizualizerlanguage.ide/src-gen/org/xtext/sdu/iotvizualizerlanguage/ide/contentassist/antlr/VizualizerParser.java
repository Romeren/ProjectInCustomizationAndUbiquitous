		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getDatasourceAccess().getGroup_8(), "rule__Datasource__Group_8__0");
					...
					put(grammarAccess.getDatasourceAccess().getDimensionsAssignment_7(), "rule__Datasource__DimensionsAssignment_7");
					put(grammarAccess.getDatasourceAccess().getDimensionsAssignment_8_1(), "rule__Datasource__DimensionsAssignment_8_1");
					put(grammarAccess.getDimensionAccess().getNameAssignment_1(), "rule__Dimension__NameAssignment_1");
					put(grammarAccess.getDimensionAccess().getFormulaAssignment_4(), "rule__Dimension__FormulaAssignment_4");
