		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getSchemaTypeAccess().getAlternatives(), "rule__SchefmaType__Alternatives");
					...
					put(grammarAccess.getDimensionalDataAccess().getGroup(), "rule__DimensionalData__Group__0");
					...
					put(grammarAccess.getDatasourceAccess().getSourceAssignment_4(), "rule__Datasource__SourceAssignment_4");
					put(grammarAccess.getDatasourceAccess().getDimensionsAssignment_5(), "rule__Datasource__DimensionsAssignment_5");
					put(grammarAccess.getDimensionalDataAccess().getDimAssignment_1(), "rule__DimensionalData__DimAssignment_1");
					put(grammarAccess.getDimensionalDataAccess().getFormulaAssignment_4(), "rule__DimensionalData__FormulaAssignment_4");
					put(grammarAccess.getURIAccess().getNameAssignment_1(), "rule__URI__NameAssignment_1");
					put(grammarAccess.getURIAccess().getUriAssignment_4(), "rule__URI__UriAssignment_4");
					put(grammarAccess.getURIAccess().getParserAssignment_6(), "rule__URI__ParserAssignment_6");
					put(grammarAccess.getSchemaParserAccess().getNameAssignment_1(), "rule__SchemaParser__NameAssignment_1");
					put(grammarAccess.getSchemaParserAccess().getSchemaTypeAssignment_4(), "rule__SchemaParser__SchemaTypeAssignment_4");
					put(grammarAccess.getSchemaParserAccess().getSelectorsAssignment_5(), "rule__SchemaParser__SelectorsAssignment_5");
					put(grammarAccess.getSelectorAccess().getVarnameAssignment_1(), "rule__Selector__VarnameAssignment_1");
